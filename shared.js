...
var LIGHT_DIRECTION = [0.0, -1.0, 0.0]; //tackice 
...
var premultiplyMatrix = function (out, matrixA, matrixB) { //ide b pa m pa b
...
var makeLookAtMatrix = function (matrix, eye, target, up) { //ovo je za normalno
